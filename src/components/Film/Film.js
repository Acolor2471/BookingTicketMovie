	...
	return (
		<div className="main imgCard" >
			...
			<div className="title">
				...
				<p className=" danhGia text-center font-bold"><span>Đánh giá: {item.danhGia}/10</span></p>
				<div className="head1">
					<div className="date">
						<p>Ngày & giờ </p>
					</div>
				...
				<div className="head3 text-center">
					<button className="btn btn-secondary opacity-90 hover:opacity-100 font-medium" onClick={() => {
						history.push(`/detail/${item.maPhim}`);
					}}>CHI TIẾT</button>
				</div></div>
			{/* <div className="head3 text-center">
